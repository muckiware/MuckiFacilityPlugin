 ...
 *
 */
namespace MuckiFacilityPlugin\Storefront\Framework\Twig\TokenParser;
...
#[Package('framework')]
final class WebPTokenParser extends AbstractTokenParser
{
    /**
     * @var Parser
     *
    ...
    public function parse(Token $token): SwInclude
    {
        ...
        $expr->setAttribute('value', '@Storefront/storefront/utilities/webp.html.twig');
